...
source "proxmox-iso" "harbor-ubuntu-jammy" {
    ...
    # iso_url = "https://mirror.cs.jmu.edu/pub/ubuntu-iso/23.10/ubuntu-23.10-live-server-amd64.iso"
    ...
    cloud_init = true
    cloud_init_storage_pool = var.proxmox_storage_type
...
build {
    ...
    provisioner "shell" {
        inline = [
            "curl -L https://github.com/goharbor/harbor/releases/download/${var.harbor_version}/harbor-offline-installer-${var.harbor_version}.tgz -o /home/ubuntu/harbor-offline-installer.tgz",
